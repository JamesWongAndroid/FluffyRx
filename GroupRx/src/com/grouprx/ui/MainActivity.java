...
public class MainActivity extends MyActivity {
	...
	private class petFundaisingTask extends AsyncTask<String, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			openFragment(new PetFundrasingFragment());
		}
...
//		sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, ""+AppSettings.getInstance().get_group_app_id_OnlyID());
	...
	private ArrayList<String> get_menu_item_left() {
		...
		list.add(getResources().getString(R.string.pet_fundraising_platform));
